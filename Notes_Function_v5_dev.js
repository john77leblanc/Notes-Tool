    ...
    <div id="editor">
      ...
      <div class="controls">
        <div>
          ...
          <button id="hi-green" tabindex="1" aria-label="Highlight green">G</button>
          <button id="hi-yellow" tabindex="1" aria-label="Highlight yellow">Y</button>
          <button id="hi-pink" tabindex="1" aria-label="Highlight pink">P</button>
        </div>
        <div>
    ...
    init: () => {
      if (!initialized) {
        ...
        sections.forEach((section, sectionIndex) => {
          ...
          section.parentNode.querySelectorAll("ul li:not(.item-collapsible) > div.cs-listitem")
      ...
      click(select("#notes-frame #hi-green"), format("hiliteColor","#00ff00"));
      click(select("#notes-frame #hi-yellow"), format("hiliteColor","#ffff00"));
      click(select("#notes-frame #hi-pink"), format("hiliteColor","ff9999"));
    },
